...
/* SkeletonProductGrid removed in A-10.23 — its only consumer was the
   ProductPicker screen, which got removed when /iq/genie6/generate started
   landing directly on the form. Restore from git history if a productid
   list-skeleton becomes needed elsewhere. */
