...
import { automationSubjects } from "@/creative-report-v2/automations/subjects";
import { evaluateRule } from "@/creative-report-v2/automations/engine";
import { isRuleEligible, type AutomationRule, type RuleAction } from "@/creative-report-v2/automations/model";
import { getRules, recordRuleRun } from "@/creative-report-v2/automations/rulesStore";
import {
  ACTION_REGISTRY,
  type WorkflowActionDescriptor,
} from "@/creative-report-v2/automations/actions/registry";
import { advanceQueue, firedFor, markFired, unmarkFired } from "@/creative-report-v2/automations/sync/syncStore";
import { toast } from "@/hooks/use-toast";

const RUNNER_ID = "creative-report-v2-automations";
