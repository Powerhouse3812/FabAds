 ...
 * exploration directions is one click away without hand-editing the URL.
 * Uses react-router `Link` (not window.location) so switching between
 * concepts is an instant client-side nav, not a full page reload.
 */
