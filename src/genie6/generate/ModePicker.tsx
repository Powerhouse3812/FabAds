      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col gap-12 px-8 py-16">
        ...
        <section className="g6-fade-up space-y-5" style={{ animationDelay: "240ms" }}>
          <div className="flex items-end justify-between">
            ...
            <p className="text-g6-xs text-g6-text-tertiary">7 modes · hover for details</p>
          </div>
        ...
        {/* Mode tooltip card — only when hovered */}
  ...
  return (
    <div className="g6-fade-up rounded-g6-xl border border-g6-primary-border bg-g6-primary-bg p-5 space-y-4">
      ...
      <dl className="grid gap-4 sm:grid-cols-3">
        <TooltipField label="Mental state" value={cfg.tooltip.mentalState} />
        <TooltipField label="Best when" value={cfg.tooltip.bestWhen} />
        <TooltipField label="Example" value={cfg.tooltip.example} />
      </dl>
    </div>
  );
}
