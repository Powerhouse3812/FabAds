...
/**
 * Product card grid skeleton — matches ProductPicker layout (4-col responsive
 * grid, aspect-[4/3] thumbnail + brand chip + 2-line title + price row).
 * Activated via `?loading=1` URL flag on /iq/genie6/generate.
 */
